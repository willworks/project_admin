...
<html lang="cn">
    <head>
        ...
        <meta name="keywords" content="广州唯量工控技术有限公司,Etomato,唯量,MEMS,质量流量计,流量计,MEMS氧气质量流量计,自动切换装置,TM2000,储罐,储罐自动切换装置,热式流量计,远程监控,数据采集器,液罐远程监控TM2000数据采集器"/>
                    ...
                    <div class="row">
                        ...
                        <div class="span6">
                            <ul class="nav nav-tabs">
                                <li><a href="admin_project_industry.php">工业案例</a></li> 
                                <li><a href="admin_project_civil.php">民用案例</a></li>
                                <li class="active"><a href="admin_project_other.php">其他案例</a></li> 
                            </ul>
                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        while($row = $res->fetch_row()){
                                            if ($row[0] == 'c' && $row[5] == 0) { 
                                                ...
                                                include("include/show_project.php");
                                            }
                                        }
                                        $res->free();
                                        $mysqli->close();
