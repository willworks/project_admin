...
<div class="row featurette">
    <div class="col-md-5">
        <img class="featurette-image img-responsive" src=<?php $img_src="project_images/{$images}";echo $img_src;?> style="width: 325px; height: 195px">
    </div>
    <div class="col-md-7">
        ...
        <div class="row featurette">
            <div class="col-md-2">
                <form form action="include/project.php" method="post" enctype="multipart/form-data">
                    <input  style="display:none" id="title" name="title" value="<?php echo "$title" ?>">
            ...
            <div class="col-md-2">
                <form form action="include/del_project.php" method="post" enctype="multipart/form-data">
                    <input  style="display:none" id="title" name="title" value="<?php echo "$title" ?>">
                    <input  style="display:none" id="images" name="images" value="<?php echo "$images" ?>">
