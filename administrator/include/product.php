                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        //----------------------------------------------------------------------------------------------------------------------------------------------------
                                            ...
                                            //获取数据库project每一列的数据
                                            $sql = "SELECT * FROM product WHERE product_name = '$name' AND product_image = '$images'";
                                            ...
                                            */
                                            ...
                                            if (!$con){
                                             ...
                                             //--------------------------------------------------
                                             $res = mysql_query("SELECT * FROM product WHERE product_name = '$name' AND product_image = '$images'");
                                             if ($res) { 
                                        ...
                                        <div class="blog-header">
                                            <h2 class="blog-title"><?php echo $name ?></h2>
                                        </div>
                                        <br>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm-12 blog-main">
                                                <div class="blog-post">
                                                    <img class="featurette-image img-responsive" src="../product_images/<?php echo $images ?>" style="width: 795px; height: 477px">
                                                </div><!-- /.blog-post -->
                                            </div><!-- /.blog-main -->
                                        </div><!-- /.row -->
                                        <br>
